...
#End Region
    ...
    Private Sub repcar_type_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim df As New SECURITY
        Try
            Dim _tmp As Cursor
            _tmp = Me.Cursor
            Me.Cursor = Cursors.WaitCursor
            Dim _rpt = New ActiveRepcartype
        ...
        "Connection TimeOut=30;"
            '*************************************************************************
            Dim _sqlString As String = "Select * FROM car_type"
            '_sqlString = _sqlString + " , car_data"
            '_sqlString = _sqlString + " WHERE car_data.type_no = car_type.type_no AND car_data.car_no = '" & car_n0_txt.Text & "'"
