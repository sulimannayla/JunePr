...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents car2_name_txt As System.Windows.Forms.TextBox
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.car2_name_txt = New System.Windows.Forms.TextBox
        ...
        'car2_name_txt
        '
        Me.car2_name_txt.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle
        Me.car2_name_txt.Font = New System.Drawing.Font("Microsoft Sans Serif", 8.25!)
        Me.car2_name_txt.Location = New System.Drawing.Point(128, 144)
        Me.car2_name_txt.Name = "car2_name_txt"
        Me.car2_name_txt.RightToLeft = System.Windows.Forms.RightToLeft.Yes
        Me.car2_name_txt.Size = New System.Drawing.Size(256, 20)
        Me.car2_name_txt.TabIndex = 1
        Me.car2_name_txt.Text = ""
        '
        'dell
        '
        ...
        Me.search.Location = New System.Drawing.Point(80, 200)
        ...
        Me.edit.Location = New System.Drawing.Point(192, 200)
        Me.edit.Name = "edit"
        ...
        Me.save.Location = New System.Drawing.Point(304, 200)
        Me.save.Name = "save"
        ...
        Me.Controls.Add(Me.car2_name_txt)
...
#End Region
    Sub num()
        ...
        ''Dim aql As String = "SELECT  DISTINCT type_no FROM car2_type"
        'Dim aql As String = "select max(type_no) type_no from car2_type  "
        ...
        Dim DS As New DataSet
        Dim t As DataTable
        Dim cmd2 As New SqlClient.SqlCommand("select max(type_no) type_no from car2_type  ", Con)
        ...
        Con.Close()
    End Sub
    Private Sub car2type_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        dell.Visible = False
        'If Con.State = ConnectionState.Broken = False Then
        '    Con.Close()
        'End If
    ...
    Private Sub save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles save.Click
        ...
        End If
        Con.Open()
        If Trim(car2_name_txt.Text) = "" Then
            MsgBox("«ﬂ„· «œŒ«· «·»Ì«‰« ")
            Exit Sub
        End If
        bt_save(edit, add1, save, search, dell)

        Dim cmdString As String = "INSERT INTO car2_type " + _
                                   "(car2_name) " + _
                                   "VALUES('" & car2_name_txt.Text.Trim & "')"
        ...
        '**************
        'Dim Cmd As New SqlClient.SqlCommand("partscar2_type_Insert", Con)
        'With Cmd
        '    .CommandType = CommandType.StoredProcedure
        '    .Parameters.Add("@scar2_name", car2_name_txt.Text.Trim)
    ...
    Private Sub edit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles edit.Click
        ...
        End If
        Con.Open()
        Dim cmdString As String = "UPDATE car2_TYPE " + _
                                            "SET car2_name = '" & car2_name_txt.Text & "' " + _
    ...
    Private Sub search_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles search.Click
        ...
        If Trim(type_no_txt.Text) = "" Then
            ...
            Exit Sub
        End If
        Dim Cmd As New SqlClient.SqlCommand("partscar2_type_SelectOne", Con)
        With Cmd
            .CommandType = CommandType.StoredProcedure
        ...
        'If dt.Rows(0).Item("car2_name") Is DBNull.Value Then
    ...
    Private Sub dell_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles dell.Click
        ...
        If str = vbYes Then
            Dim Cmd As New SqlClient.SqlCommand("partscar2_type_Delete", Con)
            With Cmd
                .CommandType = CommandType.StoredProcedure
                .Parameters.Add("@itype_no", type_no_txt.Text)
                '.Parameters.Add("@ierrorcode", "")
