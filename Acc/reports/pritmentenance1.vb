...
#End Region
    ...
    Private Sub pritmentenance1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim _sqlString As String = "Select sites.site_name,maintenance.chec1,maintenance.chec2,maintenance.medn,maintenance.car_no,maintenance.maintenance_id, maintenance.apply_person,maintenance.apply_date,maintenance.main_req,maintenance.shop_report,maintenance.notes,car_type.car_name,car_type.type_no"
        _sqlString = _sqlString + " FROM sites,car_type,maintenance,car_data"
        _sqlString = _sqlString + " WHERE maintenance.car_no=car_data.car_no and sites.site_id=car_data.site_id and maintenance.type_no = car_type.type_no  AND maintenance.maintenance_id = '" & ad2 & "'"
