...
Inherits ActiveReport
	...
	Public Sub InitializeReport()
		Me.LoadLayout(Me.GetType, "carwin.totalsal.rpx")
		...
		Me.Label1 = CType(Me.ReportHeader.Controls(2),DataDynamics.ActiveReports.Label)
		...
		Me.Label8 = CType(Me.ReportHeader.Controls(5),DataDynamics.ActiveReports.Label)
		Me.Picture = CType(Me.ReportHeader.Controls(6),DataDynamics.ActiveReports.Picture)
		Me.Shape5 = CType(Me.ReportHeader.Controls(7),DataDynamics.ActiveReports.Shape)
		Me.Line5 = CType(Me.ReportHeader.Controls(8),DataDynamics.ActiveReports.Line)
		Me.Label15 = CType(Me.GroupHeader1.Controls(0),DataDynamics.ActiveReports.Label)
		Me.Label16 = CType(Me.GroupHeader1.Controls(1),DataDynamics.ActiveReports.Label)
		Me.Label17 = CType(Me.GroupHeader1.Controls(2),DataDynamics.ActiveReports.Label)
		Me.Shape = CType(Me.GroupHeader1.Controls(3),DataDynamics.ActiveReports.Shape)
		Me.Line1 = CType(Me.GroupHeader1.Controls(4),DataDynamics.ActiveReports.Line)
		Me.Line4 = CType(Me.GroupHeader1.Controls(5),DataDynamics.ActiveReports.Line)
		Me.txtest_ok_name = CType(Me.Detail.Controls(0),DataDynamics.ActiveReports.TextBox)
		Me.txtcon_bdl_name = CType(Me.Detail.Controls(1),DataDynamics.ActiveReports.TextBox)
		Me.Line7 = CType(Me.Detail.Controls(2),DataDynamics.ActiveReports.Line)
		Me.Line8 = CType(Me.Detail.Controls(3),DataDynamics.ActiveReports.Line)
		Me.txtnot_conbdel_name = CType(Me.Detail.Controls(4),DataDynamics.ActiveReports.TextBox)
		Me.txtnot_conbdle_val = CType(Me.Detail.Controls(5),DataDynamics.ActiveReports.TextBox)
		Me.txtcon_bdl_val = CType(Me.Detail.Controls(6),DataDynamics.ActiveReports.TextBox)
		Me.txtcon_est_name = CType(Me.Detail.Controls(7),DataDynamics.ActiveReports.TextBox)
		Me.txtcon_est_val = CType(Me.Detail.Controls(8),DataDynamics.ActiveReports.TextBox)
		Me.txtest_ok_val = CType(Me.Detail.Controls(9),DataDynamics.ActiveReports.TextBox)
		Me.Line9 = CType(Me.Detail.Controls(10),DataDynamics.ActiveReports.Line)
		Me.Line10 = CType(Me.Detail.Controls(11),DataDynamics.ActiveReports.Line)
		Me.Shape4 = CType(Me.Detail.Controls(12),DataDynamics.ActiveReports.Shape)
		Me.Label = CType(Me.GroupFooter1.Controls(0),DataDynamics.ActiveReports.Label)
		Me.Label13 = CType(Me.GroupFooter1.Controls(1),DataDynamics.ActiveReports.Label)
		Me.Shape1 = CType(Me.GroupFooter1.Controls(2),DataDynamics.ActiveReports.Shape)
		Me.Label3 = CType(Me.GroupFooter1.Controls(3),DataDynamics.ActiveReports.Label)
		Me.Label5 = CType(Me.GroupFooter1.Controls(4),DataDynamics.ActiveReports.Label)
		Me.txtest_sum = CType(Me.GroupFooter1.Controls(5),DataDynamics.ActiveReports.TextBox)
		Me.Label10 = CType(Me.GroupFooter1.Controls(6),DataDynamics.ActiveReports.Label)
		Me.TextBox = CType(Me.GroupFooter1.Controls(7),DataDynamics.ActiveReports.TextBox)
		Me.safy = CType(Me.GroupFooter1.Controls(8),DataDynamics.ActiveReports.TextBox)
		Me.Label11 = CType(Me.GroupFooter1.Controls(9),DataDynamics.ActiveReports.Label)
		Me.Line2 = CType(Me.GroupFooter1.Controls(10),DataDynamics.ActiveReports.Line)
		Me.Line = CType(Me.GroupFooter1.Controls(11),DataDynamics.ActiveReports.Line)
		Me.Line3 = CType(Me.GroupFooter1.Controls(12),DataDynamics.ActiveReports.Line)
		Me.Label4 = CType(Me.GroupFooter1.Controls(13),DataDynamics.ActiveReports.Label)
		Me.Label6 = CType(Me.GroupFooter1.Controls(14),DataDynamics.ActiveReports.Label)
		Me.Shape2 = CType(Me.GroupFooter1.Controls(15),DataDynamics.ActiveReports.Shape)
		Me.Shape6 = CType(Me.GroupFooter1.Controls(16),DataDynamics.ActiveReports.Shape)
		Me.Line6 = CType(Me.GroupFooter1.Controls(17),DataDynamics.ActiveReports.Line)
		Me.Line11 = CType(Me.GroupFooter1.Controls(18),DataDynamics.ActiveReports.Line)
		Me.Label12 = CType(Me.PageFooter.Controls(0),DataDynamics.ActiveReports.Label)
		Me.TextBox2 = CType(Me.PageFooter.Controls(1),DataDynamics.ActiveReports.TextBox)
		Me.Label14 = CType(Me.PageFooter.Controls(2),DataDynamics.ActiveReports.Label)
		Me.TextBox1 = CType(Me.PageFooter.Controls(3),DataDynamics.ActiveReports.TextBox)
		Me.Label18 = CType(Me.PageFooter.Controls(4),DataDynamics.ActiveReports.Label)
		Me.TextBox3 = CType(Me.PageFooter.Controls(5),DataDynamics.ActiveReports.TextBox)
	End Sub

	#End Region
    Private Sub OrdersReport_FetchData(ByVal sender As Object, ByVal eArgs As DataDynamics.ActiveReports.ActiveReport.FetchEventArgs) Handles MyBase.FetchData
    ...
    Private Sub ReportHeader_Format(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportHeader.Format
        ...
        Dim strN As String
        'Me.Fields("alsafy_total").Value
        Label13.Text = Horof(Me.Fields("alsafy_total").Value)
    End Sub
